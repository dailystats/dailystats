...
(function () {
  ...
  const PROBLEMS_FEBRUARY = [
    ...
    { id: "10", title: "Expected value of a function", statement: `$X$ has pmf $P(X=k)=\\frac{1}{4}$ for $k=1,2,3,4$. Find $\\mathbb{E}[X^2]$.`, hint: `$\\mathbb{E}[g(X)]=\\sum_k g(k)P(X=k)$.`, solution: `$\\mathbb{E}[X^2]=\\frac{1+4+9+16}{4}=7.5$.` },
    ...
    { id: "12", title: "Chebyshev's inequality", statement: `$X$ has mean $10$ and variance $4$. Bound $P(|X-10|\\ge 4)$ using Chebyshev.`, hint: `$P(|X-\\mu|\\ge k\\sigma)\\le \\frac{1}{k^2}$.`, solution: `$k=\\frac{4}{2}=2$, so $P(|X-10|\\ge 4)\\le \\frac{1}{4}$.` },
